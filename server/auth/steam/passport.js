    ...
    User.findById(id, function(err, user){
      if(user){
        if(user.steam && user.steam.steamid && user.twitchtv && user.twitchtv.id){
          ...
          if(!_.contains(user.authItems, 'streamer') && _.contains(["76561197961827458", "76561198029304414", "76561197965807298", "76561197993261133", "76561198030744609", "76561198002590465"], user.steam.steamid)){
